Shader "Dynamic Lighting/Metallic"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include_with_pragmas "Packages/de.alpacait.dynamiclighting/AlpacaIT.DynamicLighting/Shaders/DynamicLighting.hlsl"
            ...
            v2f vert (appdata v)
            {
                ...
                o.tspace0 = float3(wTangent.x, wBitangent.x, normalWS.x);
                o.tspace1 = float3(wTangent.y, wBitangent.y, normalWS.y);
                o.tspace2 = float3(wTangent.z, wBitangent.z, normalWS.z);
            ...
            DYNLIT_FRAGMENT_FUNCTION
            {
                ...
                float3 ambient = kD * albedo.rgb * (unity_lightmap_color + dynamic_ambient_color);
        ...
        Pass
        {
            ...
            v2f ShadowVertex(appdata v)
            {
                ...
                float3 normalWS = TransformObjectToWorldNormal(v.normalOS);
                o.positionCS = TransformWorldToHClip(ApplyShadowBias(positionInputs.positionWS, normalWS, _MainLightPosition.xyz));
            ...
            {
                UNITY_SETUP_INSTANCE_ID(i);
                float alpha = _Color.a * SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, i.uv0).a;
